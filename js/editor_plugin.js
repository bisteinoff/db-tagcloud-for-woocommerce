    ...
    tinymce.create('tinymce.plugins.dbTagCloudPlugin',
        {
            ...
            {
                // Register the command so that it can be invoked by using tinyMCE.activeEditor.execCommand('mceTagCloud');
                ...
                // Register TagCloud button
                ed.addButton('tagcloud',
                    {
                        title : 'Tag Cloud',
                        cmd : 'mceTagCloud',
